      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
        <div className="lg:col-span-2 bg-white rounded-3xl p-6 border border-[#e0e0e0] shadow-sm">
          ...
          {monthlyData.length > 0 ? (
            ...
            <div className="h-[300px] flex items-center justify-center text-[#999] text-[14px]">
              No trip data yet
            </div>
          )}
        </div>
                ...
                <div key={c.country} className="flex items-center gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="h-1.5 bg-[#f0f0f0] rounded-full overflow-hidden">
                      <div
                        className="h-full bg-[#1CA698] rounded-full transition-all duration-500"
              ...
              {recentTrips.length === 0 ? (
                ...
                recentTrips.map((trip) => (
                  <tr key={trip.id} className="hover:bg-[#fcfcfc] transition-colors">
                    ...
                    <td className="px-6 py-4 text-[14px] font-bold text-[#333]">
