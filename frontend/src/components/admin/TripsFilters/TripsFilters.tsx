      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 w-full lg:w-auto">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="appearance-none rounded-xl border-2 border-[#0066D2] bg-white pl-11 pr-4 py-2.5 text-[14px] text-[#0066D2] outline-none transition-all duration-200 focus:border-[#0066D2] focus:ring-0 cursor-pointer w-full"
          />
        </div>
      </div>
    </div>
